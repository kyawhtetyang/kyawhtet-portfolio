...
const DISCOVER_ICON = (className: string) => (
...
export const buildSidebarSections = ({
...
}: SidebarConfigOptions): NavSectionConfig[] => [
  {
    title: 'Explore',
    items: [
      { category: Category.Discover, renderIcon: DISCOVER_ICON },
    ],
  },
  {
    title: 'Work',
  ...
  },
  {
    title: 'Personal',
    items: [
      { category: Category.Settings, badge: settingsBadge, renderIcon: (className) => <SettingsNavIcon className={className} /> },
    ],
  },
];
