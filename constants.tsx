...
export const APPS: AppInfo[] = [
  ...
  },
  {
    ...
    subtitle: 'Production-style mini RAG system with retrieval, evals, and VPS deployment.',
    category: Category.Projects,
    domain: 'AI/ML',
    icon: imgGroup19,
    banner: imgGroup19,
    overview: 'A small but deployment-ready RAG platform inspired by RAGFlow patterns, built to demonstrate ingestion, retrieval, citations, evaluation, and end-to-end shipping discipline.',
    stack: 'Frontend: Minimal static UI\nBackend: FastAPI\nData: PostgreSQL + pgvector\nInfra: Docker Compose + nginx\nRetrieval: vector, FTS, and hybrid modes',
    outcome: 'Shipped a public RAG demo with async ingestion, citations, evaluation endpoints, and verified VPS deployment at a recruiter-friendly quality bar.',
    developer: 'Kyaw Htet',
    featured: true,
